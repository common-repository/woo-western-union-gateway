 ...
 *
 * Provides a Western Union Payment Gateway.
 *
 * @class 		WC_Gateway_Western_Union
...
class WC_Gateway_Western_Union extends WC_Payment_Gateway {
	...
	public function __construct() {
		$this->id                 = 'wunion';
		$this->icon               = apply_filters('woocommerce_wunion_icon', plugins_url('wu.png', __FILE__));
		$this->has_fields         = false;
		$this->method_title       = __( 'Western Union', 'woocommerce' );
		$this->method_description = __( 'Permits payments using Western Union.', 'woocommerce' );
    ...
    public function init_form_fields() {
    	...
    	$this->form_fields = array(
			'enabled' => array(
				...
				'type'				=> 'checkbox',
				'label'				=> __( 'Enable Western Union?', 'woocommerce' ),
				'default'			=> 'yes'
			),
			'order_stat' => array(
