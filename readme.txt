=== WooCommerce Western Union Gateway ===
Contributors:  alexandrubr
Tags: woocommerce gateway, gateway, western union, payment
...
The plugin helps you accept payments using Western Union Transfers.
...
3. Access 'admin.php?page=wc-settings&tab=checkout&section=wunion' in order to change the description and the details provided in the email
...
The version 1.1.1 is a minor release and it should not affect affect your database settings. However, please do a full site backup and test on a staging site before deploying to a live/production server.